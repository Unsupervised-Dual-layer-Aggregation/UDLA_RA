...
def first_layer_fusion(list_method: str, dataset_path: str, evall_mode: str, top_m: int, output_dataset_path: str, output_rk_fusion_path: str, lists_file_path: str, classes_file_path: str, l_size: int, top_k: int):
    ...
    if list_method.upper() == "CPRR":
        input_data.set_param("PARAM_CPRR_L", l_size)
        input_data.set_param("PARAM_CPRR_K", top_k)
#    input_data.write_config(f"{output_dataset_path}/config_{dataset_name}.ini")
    if list_method.upper() == "RDPAC":
        ...
        input_data.set_param("PARAM_RDPAC_K_END", top_k)
...
def second_layer_fusion(list_method: str, dataset_path: str, evall_mode: str, output_dataset_path: str, output_rk_fusion_path: str, alpha: float, lists_file_path: str, classes_file_path: str, fisrt_layer_method: str, top_m: int, l_size: int, top_m_type: str, top_k: int):
